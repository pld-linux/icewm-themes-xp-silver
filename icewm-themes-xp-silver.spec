...
%description
The IceWM SilverXP Theme was inspired by the Microsoft Windows XP Silver
Theme. The title bars and window borders have the look of Windows XP.
The colors of all elements are very similar to the colors of the Windows
XP interface.

%description -l pl
Motyw SilverXP dla IceWM'a zosta³ zainspirowany motywem XP Silver dla 
systemu Microsoft Windows. Paski tytu³owe, kolory i obramowania okien
wygl±daj± i zachowuj± siê jak te w Windowsie XP.
